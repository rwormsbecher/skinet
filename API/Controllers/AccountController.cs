...
public class AccountController : BaseApiController
{
    ...
    {
        var user = await userManager.FindUserByClaimsPrincipalWithAddresss(HttpContext.User);
    ...
    public async Task<ActionResult<UserDto>> Register(RegisterDto registerDto)
    {
        ...
        {
            return new BadRequestObjectResult(new ApiValidationErrorResponse { Errors = new[] { "Emailddress is in use" } });
        }
